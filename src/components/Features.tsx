...
const FeatureCard = ({ icon, title, description, index }: FeatureCardProps) => {
  ...
  return (
    <div 
      ref={cardRef}
      className={cn(
        "feature-card glass-card opacity-0 p-4 sm:p-6 md:p-8",
        "lg:hover:bg-gradient-to-br lg:hover:from-white lg:hover:to-pulse-50",
        "transition-all duration-300"
      )}
      style={{ animationDelay: `${0.1 * index}s` }}
    >
      <div className="rounded-full bg-pulse-50 w-10 h-10 sm:w-12 sm:h-12 md:w-14 md:h-14 flex items-center justify-center text-pulse-500 mb-4 sm:mb-5">
        {icon}
      </div>
...
const Features = () => {
  ...
  return (
    <section className="py-8 sm:py-12 md:py-16 lg:py-20 pb-0 relative bg-gray-50" id="features" ref={sectionRef}>
      <div className="section-container">
        <div className="text-center mb-8 sm:mb-12 md:mb-16">
          <div className="pulse-chip mx-auto mb-3 sm:mb-4 opacity-0 fade-in-element">
            <span>Features</span>
          </div>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 opacity-0 fade-in-element">
            Technologie de Pointe, <br className="hidden sm:block" />Précision Inégalée
          </h2>
          <p className="text-base sm:text-lg md:text-xl text-gray-600 mx-auto max-w-3xl opacity-0 fade-in-element px-4 sm:px-0">
            Notre système IA révolutionne le chronométrage sportif avec une précision et une intelligence adaptative.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            title="IA Adaptative"
            description="Notre intelligence artificielle apprend des patterns de course pour optimiser en continu la précision du chronométrage."
            index={0}
          />
          <FeatureCard
            ...
            description="Traitement instantané des données de course avec des rapports détaillés et des analyses avancées."
            index={1}
          />
          <FeatureCard
            ...
            description="Capteurs haute technologie pour une détection millimétrique des passages et une précision inégalée."
            index={2}
          />
          <FeatureCard
            ...
            description="Système adaptatif capable de fonctionner dans tous types d'environnements sportifs et conditions météorologiques."
            index={3}
          />
          <FeatureCard
            ...
            description="Protection complète des données sportives avec systèmes de sauvegarde et conformité réglementaire."
            index={4}
          />
          <FeatureCard
            ...
            description="De la planification d'événement aux résultats finaux, Spixer gère tous les aspects du chronométrage sportif."
            index={5}
          />
        </div>
      </div>
